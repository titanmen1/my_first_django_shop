...
class LoginForm(forms.Form):  # форма для логина
    username = forms.CharField()
    password = forms.CharField(widget=forms.PasswordInput)

    def __init__(self, *args, **kwargs):
        super(LoginForm, self).__init__(*args, **kwargs)  # переопределение полей
        self.fields['username'].label = 'Логин'
        self.fields['password'].label = 'Пароль'

    def clean(self):  # обработка ошибок
...
class RegistrationForm(forms.ModelForm):  # форма для регистрации
    password = forms.CharField(widget=forms.PasswordInput)
    ...
    def __init__(self, *args, **kwargs):
        super(RegistrationForm, self).__init__(*args, **kwargs) # переопределение полей
        self.fields['username'].label = 'Логин'
        self.fields['password'].label = 'Пароль'
        ...
        self.fields['email'].help_text = 'Пожалуйта, указывайте реальный адрес'
...
class OrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['phone'].help_text = 'Пожалуйста, указывайте реальный номер телефонаб по которому с Вами можно связаться'
